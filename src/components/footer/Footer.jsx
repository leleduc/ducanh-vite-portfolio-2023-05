        ...
        <div className="sm:flex items-center justify-between md:gap-8">
          ...
          <div className="w-full sm:w-1/2">
            <p className="text-gray-300 leading-7 mt-4 sm:mt-0">
              Nam nibh velit, pretium in luctus non, dictum nec nibh.
              Pellentesque suscipit iaculis ultrices. Ut egestas eros quis nunc
              lobortis fringilla. Duis sed volutpat tortor. In hac habitasse
              platea dictumst.
            </p>
            <div className="flex items-center gap-4 flex-wrap md:gap-8 mt-10 ">
              ...
              <span className="w-[35px] h-[35px] p-1 bg-[#2b2d33] rounded-[50px] cursor-pointer text-center">
                <a
                  href="#github"
      ...
      <div className="bg-[#1b1e29] py-3 mt-14">
        <div className="container">
          <div className="flex items-center justify-center sm:justify-between">
            ...
            <div>
              <p>Copyright {year} develope by Duc Anh - All right reserved.</p>
            </div>
          </div>
        </div>
      </div>
